...
function SettingsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="p-4 rounded-lg bg-slate-900 border border-slate-800 hidden">
      ...
      <section className="space-x-3 p-4 rounded-lg bg-slate-900 border border-slate-800 space-y-3">
        <h2 className="text-lg font-semibold mb-2">Data</h2>
        <button
          type="button"
          onClick={handleClearFavourites}
          className="px-4 py-2 rounded bg-slate-800 text-sm cursor-pointer"
        >
          Clear favourites
        </button>
        <button
      ...
      <section className="p-4 rounded-lg bg-slate-900 border border-slate-800">
